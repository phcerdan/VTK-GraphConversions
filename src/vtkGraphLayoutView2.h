...
-------------------------------------------------------------------------*/
// .NAME vtkGraphLayoutView2 - Lays out and displays a graph
//
// .SECTION Description
// vtkGraphLayoutView2 performs graph layout and displays a vtkGraph.
...
#ifndef vtkGraphLayoutView2_h
#define vtkGraphLayoutView2_h
...
class vtkRenderedGraphRepresentation2;
class vtkViewTheme;

class VTKVIEWSINFOVIS_EXPORT vtkGraphLayoutView2 : public vtkRenderView
{
public:
  static vtkGraphLayoutView2 *New();
  vtkTypeMacro(vtkGraphLayoutView2, vtkRenderView);
...
protected:
  ...
  // Description:
  // Overrides behavior in vtkView to create a vtkRenderedGraphRepresentation2
  // by default.
  virtual vtkDataRepresentation* CreateDefaultRepresentation(vtkAlgorithmOutput* conn);
  virtual vtkRenderedGraphRepresentation2* GetGraphRepresentation();
  // Called to process events.  Overrides behavior in vtkRenderView.
  virtual void ProcessEvents(vtkObject* caller, unsigned long eventId, void* callData);

private:
  vtkGraphLayoutView2(const vtkGraphLayoutView2&);  // Not implemented.
  void operator=(const vtkGraphLayoutView2&);  // Not implemented.
