/*=========================================================================
  ...
  Module:    vtkRenderedGraphRepresentation2.h
...
-------------------------------------------------------------------------*/
// .NAME vtkRenderedGraphRepresentation2 -
//
// .SECTION Description

#ifndef vtkRenderedGraphRepresentation2_h
#define vtkRenderedGraphRepresentation2_h
...
class VTKVIEWSINFOVIS_EXPORT vtkRenderedGraphRepresentation2 : public vtkRenderedRepresentation
{
public:
  static vtkRenderedGraphRepresentation2* New();
  vtkTypeMacro(vtkRenderedGraphRepresentation2, vtkRenderedRepresentation);
...
protected:
  vtkRenderedGraphRepresentation2();
  ~vtkRenderedGraphRepresentation2();
  ...
  vtkSmartPointer<vtkGraphToPolyData2>      GraphToPoly;
...
private:
  vtkRenderedGraphRepresentation2(const vtkRenderedGraphRepresentation2&); // Not implemented
  void operator=(const vtkRenderedGraphRepresentation2&);   // Not implemented
};
