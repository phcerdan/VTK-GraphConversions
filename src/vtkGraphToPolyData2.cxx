/*=========================================================================
  ...
  Module:    vtkGraphToPolyData2.cxx
...
vtkStandardNewMacro(vtkGraphToPolyData2);

vtkGraphToPolyData2::vtkGraphToPolyData2()
{
...
int vtkGraphToPolyData2::FillInputPortInformation(int vtkNotUsed(port), vtkInformation* info)
{
  info->Set(vtkAlgorithm::INPUT_REQUIRED_DATA_TYPE(), "vtkGraph");
  return 1;
}

int vtkGraphToPolyData2::RequestData(
...
void vtkGraphToPolyData2::PrintSelf(ostream& os, vtkIndent indent)
{
