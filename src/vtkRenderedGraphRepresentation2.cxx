/*=========================================================================
  ...
  Module:    vtkRenderedGraphRepresentation2.cxx
...
vtkStandardNewMacro(vtkRenderedGraphRepresentation2);

vtkRenderedGraphRepresentation2::vtkRenderedGraphRepresentation2()
{
  ...
  this->GraphToPoly         = vtkSmartPointer<vtkGraphToPolyData2>::New();
...
void vtkRenderedGraphRepresentation2::SetVertexLabelArrayName(const char* name)
{
  this->VertexLabelHierarchy->SetLabelArrayName(name);
}

void vtkRenderedGraphRepresentation2::SetEdgeLabelArrayName(const char* name)
{
  this->EdgeLabelHierarchy->SetLabelArrayName(name);
}

const char* vtkRenderedGraphRepresentation2::GetVertexLabelArrayName()
{
  return this->VertexLabelHierarchy->GetLabelArrayName();
}

const char* vtkRenderedGraphRepresentation2::GetEdgeLabelArrayName()
{
  return this->EdgeLabelHierarchy->GetLabelArrayName();
}

void vtkRenderedGraphRepresentation2::SetVertexLabelPriorityArrayName(const char* name)
{
  this->VertexLabelHierarchy->SetPriorityArrayName(name);
}

void vtkRenderedGraphRepresentation2::SetEdgeLabelPriorityArrayName(const char* name)
{
  this->EdgeLabelHierarchy->SetPriorityArrayName(name);
}

const char* vtkRenderedGraphRepresentation2::GetVertexLabelPriorityArrayName()
{
  return this->VertexLabelHierarchy->GetPriorityArrayName();
}

const char* vtkRenderedGraphRepresentation2::GetEdgeLabelPriorityArrayName()
{
  return this->EdgeLabelHierarchy->GetPriorityArrayName();
}

void vtkRenderedGraphRepresentation2::SetVertexLabelVisibility(bool b)
{
  if (b)
    {
...
void vtkRenderedGraphRepresentation2::SetEdgeLabelVisibility(bool b)
{
  if (b)
    {
...
bool vtkRenderedGraphRepresentation2::GetVertexLabelVisibility()
{
  return this->VertexLabelHierarchy->GetInputConnection(0, 0) ==
         this->GraphToPoints->GetOutputPort();
}

bool vtkRenderedGraphRepresentation2::GetEdgeLabelVisibility()
{
  return this->EdgeLabelHierarchy->GetInputConnection(0, 0) ==
         this->EdgeCenters->GetOutputPort();
}

void vtkRenderedGraphRepresentation2::SetEdgeVisibility(bool b)
{
  this->EdgeActor->SetVisibility(b);
}

bool vtkRenderedGraphRepresentation2::GetEdgeVisibility()
{
  return this->EdgeActor->GetVisibility() ? true : false;
}

void vtkRenderedGraphRepresentation2::SetEdgeSelection(bool b)
{
  this->EdgeSelection = b;
}

bool vtkRenderedGraphRepresentation2::GetEdgeSelection()
{
  return this->EdgeSelection;
}

void vtkRenderedGraphRepresentation2::SetVertexLabelTextProperty(vtkTextProperty* p)
{
  this->VertexLabelHierarchy->SetTextProperty(p);
}

void vtkRenderedGraphRepresentation2::SetEdgeLabelTextProperty(vtkTextProperty* p)
{
  this->EdgeLabelHierarchy->SetTextProperty(p);
}

vtkTextProperty* vtkRenderedGraphRepresentation2::GetVertexLabelTextProperty()
{
  return this->VertexLabelHierarchy->GetTextProperty();
}

vtkTextProperty* vtkRenderedGraphRepresentation2::GetEdgeLabelTextProperty()
{
  return this->EdgeLabelHierarchy->GetTextProperty();
}

void vtkRenderedGraphRepresentation2::SetVertexIconArrayName(const char* name)
{
  this->ApplyVertexIcons->SetInputArrayToProcess(0, 0, 0, vtkDataObject::FIELD_ASSOCIATION_VERTICES, name);
}

void vtkRenderedGraphRepresentation2::SetEdgeIconArrayName(const char*)
{
  // TODO: Implement.
}

const char* vtkRenderedGraphRepresentation2::GetVertexIconArrayName()
{
  // TODO: Implement.
  return 0;
}

const char* vtkRenderedGraphRepresentation2::GetEdgeIconArrayName()
{
  // TODO: Implement.
  return 0;
}

void vtkRenderedGraphRepresentation2::SetVertexIconPriorityArrayName(const char*)
{
  // TODO: Implement.
}

void vtkRenderedGraphRepresentation2::SetEdgeIconPriorityArrayName(const char*)
{
  // TODO: Implement.
}

const char* vtkRenderedGraphRepresentation2::GetVertexIconPriorityArrayName()
{
  // TODO: Implement.
  return 0;
}

const char* vtkRenderedGraphRepresentation2::GetEdgeIconPriorityArrayName()
{
  // TODO: Implement.
  return 0;
}

void vtkRenderedGraphRepresentation2::SetVertexIconVisibility(bool b)
{
  this->VertexIconActor->SetVisibility(b);
}

void vtkRenderedGraphRepresentation2::SetEdgeIconVisibility(bool)
{
  // TODO: Implement.
}

bool vtkRenderedGraphRepresentation2::GetVertexIconVisibility()
{
  return (this->VertexIconActor->GetVisibility() ? true : false);
}

bool vtkRenderedGraphRepresentation2::GetEdgeIconVisibility()
{
  // TODO: Implement.
  return false;
}

void vtkRenderedGraphRepresentation2::AddVertexIconType(const char* name, int type)
{
  this->ApplyVertexIcons->SetIconType(name, type);
  this->ApplyVertexIcons->UseLookupTableOn();
}

void vtkRenderedGraphRepresentation2::AddEdgeIconType(const char*, int)
{
  // TODO: Implement.
}

void vtkRenderedGraphRepresentation2::ClearVertexIconTypes()
{
  this->ApplyVertexIcons->ClearAllIconTypes();
  this->ApplyVertexIcons->UseLookupTableOff();
}

void vtkRenderedGraphRepresentation2::ClearEdgeIconTypes()
{
  // TODO: Implement.
}

void vtkRenderedGraphRepresentation2::SetUseVertexIconTypeMap(bool b)
{
  this->ApplyVertexIcons->SetUseLookupTable(b);
}

void vtkRenderedGraphRepresentation2::SetUseEdgeIconTypeMap(bool)
{
  // TODO: Implement.
}

bool vtkRenderedGraphRepresentation2::GetUseVertexIconTypeMap()
{
  return this->ApplyVertexIcons->GetUseLookupTable();
}

bool vtkRenderedGraphRepresentation2::GetUseEdgeIconTypeMap()
{
  // TODO: Implement.
  return false;
}
...
// TODO: Icon alignment
void vtkRenderedGraphRepresentation2::SetVertexIconAlignment(int align)
{
  (void)align;
}

int vtkRenderedGraphRepresentation2::GetVertexIconAlignment()
{
  return 0;
}

void vtkRenderedGraphRepresentation2::SetEdgeIconAlignment(int align)
{
  (void)align;
}

int vtkRenderedGraphRepresentation2::GetEdgeIconAlignment()
{
  return 0;
}

void vtkRenderedGraphRepresentation2::SetVertexSelectedIcon(int icon)
{
  this->ApplyVertexIcons->SetSelectedIcon(icon);
}

int vtkRenderedGraphRepresentation2::GetVertexSelectedIcon()
{
  return this->ApplyVertexIcons->GetSelectedIcon();
}

void vtkRenderedGraphRepresentation2::SetVertexDefaultIcon(int icon)
{
  this->ApplyVertexIcons->SetDefaultIcon(icon);
}

int vtkRenderedGraphRepresentation2::GetVertexDefaultIcon()
{
  return this->ApplyVertexIcons->GetDefaultIcon();
}

void vtkRenderedGraphRepresentation2::SetVertexIconSelectionMode(int mode)
{
  this->ApplyVertexIcons->SetSelectionMode(mode);
}

int vtkRenderedGraphRepresentation2::GetVertexIconSelectionMode()
{
  return this->ApplyVertexIcons->GetSelectionMode();
}

void vtkRenderedGraphRepresentation2::SetColorVerticesByArray(bool b)
{
  this->ApplyColors->SetUsePointLookupTable(b);
}

bool vtkRenderedGraphRepresentation2::GetColorVerticesByArray()
{
  return this->ApplyColors->GetUsePointLookupTable();
}

void vtkRenderedGraphRepresentation2::SetVertexColorArrayName(const char* name)
{
...
const char* vtkRenderedGraphRepresentation2::GetVertexColorArrayName()
{
  return this->GetVertexColorArrayNameInternal();
}

void vtkRenderedGraphRepresentation2::SetColorEdgesByArray(bool b)
{
  this->ApplyColors->SetUseCellLookupTable(b);
}

bool vtkRenderedGraphRepresentation2::GetColorEdgesByArray()
{
  return this->ApplyColors->GetUseCellLookupTable();
}

void vtkRenderedGraphRepresentation2::SetEdgeColorArrayName(const char* name)
{
...
const char* vtkRenderedGraphRepresentation2::GetEdgeColorArrayName()
{
  return this->GetEdgeColorArrayNameInternal();
}

// TODO: Implement enable stuff.
void vtkRenderedGraphRepresentation2::SetEnableVerticesByArray(bool b)
{
  (void)b;
}

bool vtkRenderedGraphRepresentation2::GetEnableVerticesByArray()
{
  return false;
}

void vtkRenderedGraphRepresentation2::SetEnabledVerticesArrayName(const char* name)
{
  (void)name;
}

const char* vtkRenderedGraphRepresentation2::GetEnabledVerticesArrayName()
{
  return 0;
}

void vtkRenderedGraphRepresentation2::SetEnableEdgesByArray(bool b)
{
  (void)b;
}

bool vtkRenderedGraphRepresentation2::GetEnableEdgesByArray()
{
  return false;
}

void vtkRenderedGraphRepresentation2::SetEnabledEdgesArrayName(const char* name)
{
  (void)name;
}

const char* vtkRenderedGraphRepresentation2::GetEnabledEdgesArrayName()
{
  return 0;
}

void vtkRenderedGraphRepresentation2::SetGlyphType(int type)
{
...
int vtkRenderedGraphRepresentation2::GetGlyphType()
{
  return this->VertexGlyph->GetGlyphType();
}

void vtkRenderedGraphRepresentation2::SetScaling(bool b)
{
  this->VertexGlyph->SetScaling(b);
  this->OutlineGlyph->SetScaling(b);
}

bool vtkRenderedGraphRepresentation2::GetScaling()
{
  return this->VertexGlyph->GetScaling();
}

void vtkRenderedGraphRepresentation2::SetScalingArrayName(const char* name)
{
...
const char* vtkRenderedGraphRepresentation2::GetScalingArrayName()
{
  return this->GetScalingArrayNameInternal();
}

void vtkRenderedGraphRepresentation2::SetVertexScalarBarVisibility(bool b)
{
  this->VertexScalarBar->GetScalarBarActor()->SetVisibility(b);
}

bool vtkRenderedGraphRepresentation2::GetVertexScalarBarVisibility()
{
  return this->VertexScalarBar->GetScalarBarActor()->GetVisibility() ? true : false;
}

void vtkRenderedGraphRepresentation2::SetEdgeScalarBarVisibility(bool b)
{
  this->EdgeScalarBar->GetScalarBarActor()->SetVisibility(b);
}

bool vtkRenderedGraphRepresentation2::GetEdgeScalarBarVisibility()
{
  return this->EdgeScalarBar->GetScalarBarActor()->GetVisibility() ? true : false;
}

vtkScalarBarWidget* vtkRenderedGraphRepresentation2::GetVertexScalarBar()
{
  return this->VertexScalarBar.GetPointer();
}

vtkScalarBarWidget* vtkRenderedGraphRepresentation2::GetEdgeScalarBar()
{
  return this->EdgeScalarBar.GetPointer();
}

bool vtkRenderedGraphRepresentation2::IsLayoutComplete()
{
  return this->Layout->IsLayoutComplete() ? true : false;
}

void vtkRenderedGraphRepresentation2::UpdateLayout()
{
...
void vtkRenderedGraphRepresentation2::SetLayoutStrategy(vtkGraphLayoutStrategy* s)
{
  if (!s)
    {
...
vtkGraphLayoutStrategy* vtkRenderedGraphRepresentation2::GetLayoutStrategy()
{
  return this->Layout->GetLayoutStrategy();
}

void vtkRenderedGraphRepresentation2::SetLayoutStrategy(const char* name)
{
  std::string str = name;
...
void vtkRenderedGraphRepresentation2::SetLayoutStrategyToAssignCoordinates(
  const char* xarr,
  const char* yarr,
  const char* zarr)
{
...
void vtkRenderedGraphRepresentation2::SetLayoutStrategyToTree(
  bool radial,
  double angle,
  double leafSpacing,
  double logSpacing)
...
void vtkRenderedGraphRepresentation2::SetLayoutStrategyToCosmicTree(
...
void vtkRenderedGraphRepresentation2::SetEdgeLayoutStrategy(vtkEdgeLayoutStrategy* s)
{
  if (!s)
    {
    vtkErrorMacro("Layout strategy must not be NULL.");
...
vtkEdgeLayoutStrategy* vtkRenderedGraphRepresentation2::GetEdgeLayoutStrategy()
{
  return this->EdgeLayout->GetLayoutStrategy();
}

void vtkRenderedGraphRepresentation2::SetEdgeLayoutStrategy(const char* name)
{
  std::string str = name;
  std::transform(str.begin(), str.end(), str.begin(), tolower);
  str.erase(std::remove(str.begin(), str.end(), ' '), str.end());
...
void vtkRenderedGraphRepresentation2::SetEdgeLayoutStrategyToGeo(double explodeFactor)
{
...
bool vtkRenderedGraphRepresentation2::AddToView(vtkView* view)
{
...
bool vtkRenderedGraphRepresentation2::RemoveFromView(vtkView* view)
{
...
void vtkRenderedGraphRepresentation2::PrepareForRendering(vtkRenderView* view)
{
...
vtkSelection* vtkRenderedGraphRepresentation2::ConvertSelection(
...
int vtkRenderedGraphRepresentation2::RequestData(
  vtkInformation*,
...
void vtkRenderedGraphRepresentation2::ApplyViewTheme(vtkViewTheme* theme)
{
...
//----------------------------------------------------------------------------
void vtkRenderedGraphRepresentation2::ComputeSelectedGraphBounds(double bounds[6] )
{
...
vtkUnicodeString vtkRenderedGraphRepresentation2::GetHoverTextInternal(vtkSelection* sel)
{
  vtkGraph* input = vtkGraph::SafeDownCast(this->GetInput());
...
void vtkRenderedGraphRepresentation2::PrintSelf(ostream& os, vtkIndent indent)
{
